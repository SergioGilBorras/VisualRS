...
import tree_visualize.similarity_measure_base.Kendalls;
 ...
 */
public class FJaccardKendalls extends Similarity_measure_final {

    Kendalls pc;
    Jaccard jc;

    /**
     * Create the Jaccard-Kendalls correlation, combination of Jaccard and
     * Kendalls correlation. It is a similarity measure final
     */
    public FJaccardKendalls() {
        this.name = "Jaccard x Kendalls Correlation";
        pc = new Kendalls();
        jc = new Jaccard();
    }
