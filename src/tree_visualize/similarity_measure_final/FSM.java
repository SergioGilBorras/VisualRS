...
import tree_visualize.similarity_measure_base.SM;
 ...
 */
public class FSM extends Similarity_measure_final {
     ...
     */
    public FSM(Generate_similarity_vectors_simple gvss) throws Exception {
        this.name = "SM Correlation";
        pc = new SM(4, gvss.Similarity_positive(), gvss.Similarity_negative());
    }
