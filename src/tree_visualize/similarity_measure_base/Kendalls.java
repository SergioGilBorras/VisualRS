 ...
 */
public class Kendalls extends Similarity_measure_base {

    KendallsCorrelation pc;

    /**
     * Create the Kendall Rank Correlation Coefficient a similarity measure base
     */
    public Kendalls() {
        pc = new KendallsCorrelation();
    }
