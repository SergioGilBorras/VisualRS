...
import org.etsisi.visualrs.similarityMeasureBase.Spearmans;
 ...
 * related information'"
 */
public class FJaccardSpearmans extends SimilarityMeasureFinal {

    Spearmans pc;
    Jaccard jc;

    /**
     * Create the Jaccard-Spearmans correlation, combination of Jaccard and
     * Spearmans correlation. It is a similarity measure final
     */
    public FJaccardSpearmans() {
        this.name = "Jaccard x Spearmans Correlation";
        pc = new Spearmans();
        jc = new Jaccard();
    }
