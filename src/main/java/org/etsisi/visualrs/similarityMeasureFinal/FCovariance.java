 ...
 */
public class FCovariance extends SimilarityMeasureFinal {

    CovarianceN pc;

    /**
     * Create the Covariance correlation. It is a similarity measure final
     */
    public FCovariance() {
        this.name = "Covarianza Correlation";
        pc = new CovarianceN();
    }
