...
import org.etsisi.visualrs.similarityMeasureBase.CovarianceN;
 ...
 * related information'"
 */
public class FJaccardCovariance extends SimilarityMeasureFinal {

    CovarianceN pc;
    Jaccard jc;

    /**
     * Create the Jaccard-Covariance correlation, combination of Jaccard
     * correlation and Covariance. It is a similarity measure final
     */
    public FJaccardCovariance() {
        this.name = "Jaccard x Covariance Correlation";
        pc = new CovarianceN();
        jc = new Jaccard();
    }
