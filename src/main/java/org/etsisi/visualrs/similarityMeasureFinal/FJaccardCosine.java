...
import org.etsisi.visualrs.similarityMeasureBase.Cosine;
 ...
 */
public class FJaccardCosine extends SimilarityMeasureFinal {

    Cosine pc;
    Jaccard jc;

    /**
     * Create the Jaccard-Cosine correlation, combination of Jaccard
     * correlation and Cosine. It is a similarity measure final
     */
    public FJaccardCosine() {
        this.name = "Jaccard x Cosine Correlation";
        pc = new Cosine();
        jc = new Jaccard();
    }
